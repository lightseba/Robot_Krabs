...
public class BingListener extends ListenerAdapter {
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            JDA jda = new JDABuilder(AccountType.BOT)
                    .setToken(Keys.discordKey)           //The token of the account that is logging in.
                    .addEventListener(new BingListener())  //An instance of a class that will handle events.
    ...
    public void onMessageReceived(MessageReceivedEvent event)
    {
        ...
        if (msg.length() > 5 && msg.startsWith("!bing"))
        {
